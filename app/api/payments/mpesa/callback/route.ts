...
import { isStkCallbackPayload, parseStkCallback } from '@/lib/mpesa';

/**
 * POST /api/payments/mpesa/callback
 * Public endpoint called by Safaricom Daraja after STK Push completes.
 *
...
export async function POST(request: NextRequest) {
  try {
    ...
    const selectCols =
      'id, status, amount, phone_number, checkout_request_id, merchant_request_id';
