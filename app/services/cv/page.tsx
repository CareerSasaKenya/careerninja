...
export default function CVServicesPage() {
  ...
  const packages = [
    {
      id: "graduate-starter",
      title: "🟢 Graduate Starter Package",
      ...
      price: "KES 2,500 – 4,000",
      whatsappMessage: "Hi, I'm interested in the Graduate Starter Package."
    },
    {
      id: "job-seeker",
      title: "🔵 Job Seeker CV Package (Most Popular)",
      subtitle: "For active job seekers",
      services: [
        "Professional CV writing or rewrite",
        "ATS optimization",
        "Role-specific positioning"
      ],
      price: "KES 4,000 – 6,500",
      whatsappMessage: "Hi, I'm interested in the Job Seeker CV Package."
    },
    {
      id: "growth",
      title: "🟣 Career Growth CV Package",
      subtitle: "For experienced professionals",
      services: [
        "Advanced CV rewrite",
        "Achievement & impact positioning",
        "Industry-specific keywords"
      ],
      price: "KES 6,500 – 9,000",
      whatsappMessage: "Hi, I'm interested in the Career Growth CV Package."
    },
    {
      id: "executive-package",
      title: "🔴 Executive CV Package",
      subtitle: "For senior professionals & leaders",
      services: [
        "Executive-level CV",
        "Leadership & results focus",
        "Confidential, tailored approach"
      ],
      price: "KES 10,000 – 18,000",
      whatsappMessage: "Hi, I'm interested in the Executive CV Package."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {/* Bundled Packages */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">CV & Resume Packages</h2>
            ...
            <div className="text-center">
              ...
              <Link href="https://wa.me/254795564135?text=Hi,%20I'm%20interested%20in%20a%20custom%20CV%20solution." target="_blank">
                <Button className="bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white px-10 py-4 text-xl font-semibold rounded-xl transition-all duration-200 transform hover:scale-105">
                  👉 Contact us for a custom CV solution
                </Button>
              </Link>
            </div>
          </div>
