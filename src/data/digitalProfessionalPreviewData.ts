  ...
  projects: [
    {
      ...
      description:
        "Built a full-stack e-commerce platform with authentication, payment integration, inventory management, and admin dashboard. Implemented real-time order tracking and email notifications. Achieved 99.9% uptime and handled 10K+ monthly transactions.",
    ...
    },
    {
      ...
      description:
        "Developed a comprehensive job board platform allowing companies to post jobs and candidates to apply online. Features include advanced search filters, application tracking, and automated email campaigns. Serves 500+ active employers.",
    ...
    },
    {
      ...
      description:
        "Created a real-time analytics dashboard for monitoring business metrics with interactive charts and live data updates. Integrated with multiple data sources and implemented custom visualization components.",
    ...
    },
    {
      ...
      description:
        "Designed and implemented secure RESTful APIs for a mobile banking application. Handled transaction processing, account management, and third-party payment gateway integration with PCI DSS compliance."
    }
  ],
