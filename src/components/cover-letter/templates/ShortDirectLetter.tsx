/**
 * Short & Direct Cover Letter Template
 * Concise 3-paragraph layout for startups, tech companies, and online applications.
 * A4 size: 794px x 1123px — matches CV template dimensions exactly.
 * Action-oriented tone, tight spacing, recruiter-friendly.
 */

import React from 'react';

export interface ShortDirectLetterData {
  name: string;
  phone: string;
  email: string;
  location: string;
...
export default function ShortDirectLetter({ data }: Props) {
  return (
    <div className="w-[794px] h-[1123px] bg-white px-16 py-12 font-sans text-gray-800 shadow-lg print:shadow-none overflow-hidden">
      ...
      {/* Body — tight spacing, impact-focused */}
