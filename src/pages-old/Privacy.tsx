...
export default function Privacy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - How We Protect Your Data | CareerSasa</title>
        <meta name="description" content="Learn how CareerSasa collects, uses, and protects your personal information. We are committed to your privacy and data security." />
      </Helmet>
