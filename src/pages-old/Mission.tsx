...
export default function Mission() {
  return (
    <>
      <Helmet>
        <title>Our Mission - Enriching Careers Across Kenya | CareerSasa</title>
        <meta name="description" content="Discover CareerSasa's mission to transform Kenya's job market by connecting talent with opportunity, fostering career growth, and empowering both job seekers and employers." />
      </Helmet>
