      ...
      <CardContent className="space-y-6">
        {salaryDetails.length > 0 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {salaryDetails.map((item, index) => renderDetailItem(item))}
            </div>
          </div>
        )}
        ...
        {jobDetails.length > 0 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {jobDetails.map((item, index) => renderDetailItem(item))}
            </div>
          </div>
        )}
        ...
        {requirements.length > 0 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {requirements.map((item, index) => renderDetailItem(item))}
            </div>
          </div>
        )}
        ...
        {additionalDetails.length > 0 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {additionalDetails.map((item, index) => renderDetailItem(item))}
            </div>
          </div>
        )}
      </CardContent>
