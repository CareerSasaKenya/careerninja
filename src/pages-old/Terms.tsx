...
export default function Terms() {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions - CareerSasa Job Portal</title>
        <meta name="description" content="Read CareerSasa's terms and conditions for using our job portal. Understand your rights and responsibilities as a user of our platform." />
      </Helmet>
